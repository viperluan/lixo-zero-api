...
4. A edição vigente é a única que aceita cadastro, prorrogação e troca de inscrições. O título da ação é único dentro da edição, não na base inteira. Ano anterior ao calendário atual não é criado nem volta a ser vigente. Ano atual ou futuro pode substituir a vigente, mesmo que seja menor que ela, e edição vazia (inclusive a vigente) pode ser excluída.
